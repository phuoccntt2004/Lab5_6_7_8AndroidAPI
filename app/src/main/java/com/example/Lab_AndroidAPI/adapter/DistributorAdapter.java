...
import com.example.Lab_AndroidAPI.MainActivity;
...
public class DistributorAdapter extends RecyclerView.Adapter<DistributorAdapter .DistributorHolder> {
    ...
    public DistributorAdapter(List<Distributor> distributors, Context context, HttpRequest request, Callback responeCallBack) {
